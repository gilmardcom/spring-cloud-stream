...
public class AskMeServiceApplication {

    private static final Logger LOG = LoggerFactory.getLogger(AskMeServiceApplication.class);

    AskMeServiceImpl askMeService;
    ...
    public static void main(String[] args) {
        SpringApplication.run(AskMeServiceApplication.class, args);
    }
